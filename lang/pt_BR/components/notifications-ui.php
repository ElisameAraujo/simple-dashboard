...
return [
    'title' => 'Notificações',
    'trigger_label' => 'Abrir notificações',
    'backend_free' => 'Apenas UI',
    'unread_count' => '{0}Nenhuma notificação não lida|{1}:count notificação não lida|[2,*]:count notificações não lidas',
    'actions' => [
    ...
    'modal' => [
        'title' => 'Notificações',
        'description' => 'Exemplos visuais prontos para conectar ao back-end do projeto.',
        'footer' => 'Substitua os exemplos pela fonte de notificações do seu projeto.',
    ],
    'empty' => [
