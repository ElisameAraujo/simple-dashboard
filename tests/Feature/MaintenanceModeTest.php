...
class MaintenanceModeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Route::middleware('site.available')
            ->get('/maintenance-test-public', fn () => 'Public page')
            ->name('maintenance.test-public');
    }
    ...
    public function test_visitor_receives_503_when_maintenance_mode_is_enabled(): void
    {
        ...
        $this->get('/maintenance-test-public')
            ->assertStatus(503)
    ...
    {
        $this->get(route('admin.configs.maintenance'))
            ->assertOk()
            ->assertSee(__('components/maintenance-mode.title'));
    }
